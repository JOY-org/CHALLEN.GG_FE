        ...
        <div className={styleHome.Home}>
            ...
            <div className={styleHome.level}>
                ...
                <div>
                    ...
                    <p className={styleHome.LevelText}>2.엔돌핀: 5회 이상 8회미만 귀요미 챌린저</p>
                    <p className={styleHome.LevelText}>3.에너지: 8회이상 13회미만 프로챌린저의 태가 나는 챌린저</p>
                    <p className={styleHome.LevelText}>4.엔돌핀: 13회이상 21회미만 세미프로 챌린저</p>
                    <p className={styleHome.LevelText}>5.카이저: 21회이상 프로 챌린저이자 챌린지지가 인정한 갓생러</p>
                </div>
            </div>
